    ...
    <section id="contact" style={{
      ...
      <div style={{
        ...
        <form style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem', marginBottom: '2rem' }}>
          <input type="text" placeholder="Your Name" required style={{ padding: '0.75rem', borderRadius: 10, border: '1px solid #ccc', fontSize: '1rem' }} />
          <input type="email" placeholder="Your Email" required style={{ padding: '0.75rem', borderRadius: 10, border: '1px solid #ccc', fontSize: '1rem' }} />
          <textarea placeholder="Your Message" required rows={4} style={{ padding: '0.75rem', borderRadius: 10, border: '1px solid #ccc', fontSize: '1rem' }} />
